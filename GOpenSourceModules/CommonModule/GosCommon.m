...
//                unsigned long red = strtoul([@"0x6587" UTF8String],0,0);
                ...
                _devlistTabOn = [[jsonObject objectForKey:@"devlistTab"] boolValue];
...
- (BOOL)setApplicationInfo:(NSDictionary *)info {
    @try {
        if (nil == info) {
            [GizWifiSDK startWithAppID:APP_ID appSecret:APP_SECRET specialProductKeys:nil cloudServiceInfo:@{@"openAPIInfo": DEFAULT_API_DOMAIN,
            ...
            [GizWifiSDK startWithAppID:appid appSecret:APP_SECRET specialProductKeys:nil cloudServiceInfo:mInfo autoSetDeviceDomain:NO];
